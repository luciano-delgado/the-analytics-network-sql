create
or replace procedure etl.sp_order_line_sales() language sql as $ $ truncate fct.order_line_sales;

insert into
    fct.order_line_sales
select
    orden,
    producto,
    tienda,
    ...
    moneda,
    pos,
    is_walkout --> Especifico columnas ya que la 1ra tiene SERIAL ID
from
    stg.order_line_sales ols
