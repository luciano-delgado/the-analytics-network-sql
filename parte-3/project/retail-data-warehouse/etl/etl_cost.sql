...
language sql as $$
-- buscar codigo de producto existente en product_master y traer solo los que existen
-- insert basado en la nueva tabla/cte con los codigos que existen unicamente
with validacion as (
